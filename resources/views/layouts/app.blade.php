...
<head>
  ...
  <script src="https://maps.googleapis.com/maps/api/js?key={{ config('AIzaSyDrtrDPXSxRDMWbrCSeyM1uAtU4RuJl3vg') }}"></script>
      <script>
      document.addEventListener('DOMContentLoaded', function() {
        function openMapPopup() {
          var mapOptions = {
            center: { lat: -6.20983028411865, lng: 106.807762145996 },
            zoom: 15
          };
