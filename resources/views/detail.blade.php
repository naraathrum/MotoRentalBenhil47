<x-front-layout>
  ...
  <!-- FAQ -->
  <section class=" relative py-[100px] bg-lalala px-4 sm:px-4">
    ...
    <div class="grid md:grid-cols-2 gap-x-[50px] gap-y-6 max-w-[910px] w-full mx-auto">
      <a href="#!" class="px-6 py-4 border rounded-[24px] border-dark h-min accordion max-w-[430px]"
        ...
        <div class="flex items-center justify-between gap-1">
          <p class="text-base font-semibold text-dark">
            Bagaimana kalau terdapat baret pada bodi?
          </p>
      ...
      <a href="#!" class="px-6 py-4 border rounded-[24px] border-dark h-min accordion max-w-[430px]"
        ...
        <div class="flex items-center justify-between gap-1">
          <p class="text-base font-semibold text-dark">
          Bagaimana cara menghubungi pihak rental?
          </p>
          <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
        </div>
      ...
      <a href="#!" class="px-6 py-4 border rounded-[24px] border-dark h-min accordion max-w-[430px]"
        ...
        <div class="flex items-center justify-between gap-1">
          <p class="text-base font-semibold text-dark">
            Kapan waktu pemesanan yang cocok?
          </p>
          <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
        </div>
      ...
      <a href="#!" class="px-6 py-4 border rounded-[24px] border-dark h-min accordion max-w-[430px]"
        ...
        <div class="flex items-center justify-between gap-1">
          <p class="text-base font-semibold text-dark">
          Apakah terdapat denda kalau lewat hari?  
          </p>
          <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
        </div>
      ...
      <a href="#!" class="px-6 py-4 border rounded-[24px] border-dark h-min accordion max-w-[430px]"
        ...
        <div class="flex items-center justify-between gap-1">
          <p class="text-base font-semibold text-dark">
            Apakah tetap buka di hari minggu?
          </p>
          <img src="/svgs/ic-chevron-down-rounded.svg" class="transition-all" alt="">
        </div>
