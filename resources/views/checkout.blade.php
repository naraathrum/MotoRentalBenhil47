<x-front-layout>
  <!-- Main Content -->
  <section class="bg-darkGrey h-[1000px] sm:h-fit py-[70px]">
          ...
          <div class="grid grid-cols-2 items-center gap-y-6 gap-x-4 lg:gap-x-[30px]">
            ...
            <div class="flex flex-col col-span-2 gap-3">
              ...
              <input type="text" name="name" id="fullname" required
                     class="text-base font-medium focus:border-primary focus:outline-none placeholder:text-secondary placeholder:font-normal px-[26px] py-4 border border-dark rounded-[50px]"
            ...
            <div class="col-span-2 grid grid-cols-2 gap-y-6 gap-x-4 lg:gap-x-[30px] relative"
              ...
              <div class="flex flex-col col-span-1 gap-3">
                ...
                <input readonly type="text"
                       class="text-base font-medium focus:border-primary focus:outline-none placeholder:text-secondary placeholder:font-normal px-[26px] py-4 border border-dark rounded-[50px] focus:before:appearance-none focus:before:!content-none"
            ...
            <div class="flex flex-col col-span-2 gap-3">
              ...
              <input type="text" name="address" id="address" required
                     class="text-base font-medium focus:border-primary focus:outline-none placeholder:text-secondary placeholder:font-normal px-[26px] py-4 border border-dark rounded-[50px]"
                     placeholder="Where should we deliver your motorcycle?">
            </div>
